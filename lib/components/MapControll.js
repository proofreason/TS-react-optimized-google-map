...
var MapControll = function (props) {
    ...
    var _d = useContext(MapMounterContext_1.default), mapContex = _d[0], setMapContext = _d[1];
    ...
    React.useEffect(function () {
        ...
        setDivIndex(index);
        return function () {
            var renderedAfterPreviousRemove = map.controls[props.position].getAt(index);
    ...
    return controllLoaded && controlDiv && react_dom_1.createPortal(props.children, controlDiv);
};
exports.default = MapControll;
