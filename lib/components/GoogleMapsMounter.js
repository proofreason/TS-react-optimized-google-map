...
var MarkerMounter_1 = __importDefault(require("./googleMapsMounters/MarkerMounter"));
...
var GoogleMapsMounter = React.memo(function (props) {
    ...
    return (React.createElement(MapMounterContext_1.default.Provider, { value: context },
        React.createElement("div", { className: 'react-map-content-wrapper', style: mapWrapperStyle },
            mapElement,
            contextState.map &&
                (props.withMounter ? (React.createElement(MarkerMounter_1.default, { onMountedMarkersUpdateFinish: getMountedMarkers, key: 0 },
